...
/* @var $searchModel common\models\searches\NoteSupplementalSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->params['breadcrumbs'][] = $this->title;
?>
<div class="note-supplemental-index box box-primary">
    <div class="box-header with-border">
        <p class="text-right">
            <?= Html::a(Yii::t('app', 'Add Physician Order'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
        </p>
    </div>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [ // buttons
                    ...
                    'template' => '{view}{update}{accept}{reject}{document/note-supplemental}',
                    'buttons' => [
                        ...
                        'document/note-supplemental' => function ($url, $model, $key) {
                            if (!$model->isPending()) {
