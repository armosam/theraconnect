...
<div class="note-supplemental-form box box-primary">
    <?php $form = ActiveForm::begin(['id' => 'supplemental-form']); ?>
    <div class="box-body table-responsive">
        ...
        <?php if($model->isNewRecord): ?>
            <div class="col-lg-12">
                ...
                <div class="col-lg-4"><?= $form->field($model, 'order_id')->widget(DepDrop::class, [
                        'options' => ['id'=>'notesupplemental-order_id'],
                        'pluginOptions'=>[
                            'depends'=>['notesupplemental-provider_id'],
                ...
                <div class="col-lg-4"><?= $form->field($model, 'visit_id')->widget(DepDrop::class, [
                        'options' => ['id'=>'notesupplemental-visit_id'],
                        'pluginOptions'=>[
                            'depends'=>['notesupplemental-provider_id', 'notesupplemental-order_id'],
        ...
        <?php /* $form->field($model, 'frequency')->widget(MaskedInput::class, [
            'mask' => '9w9',
            'clientOptions' => [
                "separator" => "w"
            ]])->textInput()*/ ?>
