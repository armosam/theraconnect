...
<div class="user-form box box-primary">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <?=  $form->field($model->avatar, 'upload_file')->widget(FileInput::class, [
                ...
                'pluginOptions' => [
                    ...
                    'showUpload' => false,
                    'initialPreview' => [Html::img(Yii::$app->urlManagerToFront->createUrl(['/site/avatar', 'id'=>$model->avatar->id,
                        'w'=>Yii::$app->params['avatarImage']['width'],
                        'q'=>Yii::$app->params['avatarImage']['quality'],
                        's'=>Yii::$app->params['picturePreferredSourceFileSystem']
                    ]), ['width'=>200])],
                ]])->label(Yii::t('app', 'Upload user photo or agency logo')) ?>
            ...
            <?php if ($model->isNewRecord): ?>
            <div class="col-lg-12">
                <?= $form->field($role, 'item_name')->dropDownList($model::getRoleList(), ['prompt'=>'-- Select Role --']) ?>
            </div>
            <?php else: ?>
        ...
        <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <?= $form->field($model, 'gender')->dropDownList($model->genderList, ['prompt'=>'-- Select Gender --']) ?>
            </div>
