        ...
        <?php if($model->isNewRecord): ?>
            <div class="col-lg-12">
                ...
                <div class="col-lg-4"><?= $form->field($model, 'order_id')->widget(DepDrop::class, [
                        'options' => ['id'=>'notedischargeorder-order_id'],
                        'pluginOptions'=>[
                            'depends'=>['notedischargeorder-provider_id'],
                ...
                <div class="col-lg-4"><?= $form->field($model, 'visit_id')->widget(DepDrop::class, [
                        'options' => ['id'=>'notedischargeorder-visit_id'],
                        'pluginOptions'=>[
                            'depends'=>['notedischargeorder-provider_id', 'notedischargeorder-order_id'],
