...
/* @var $searchModel common\models\searches\NoteProgressSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->params['breadcrumbs'][] = $this->title;
?>
<div class="note-progress-index box box-primary">
    <div class="box-header with-border">
        <p class="text-right">
            <?= Html::a(Yii::t('app', 'Add Progress Note'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
        </p>
    </div>
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        return ConstHelper::getNoteStatusList($model->status) . ( ($model->isSubmitted() && empty($model->therapist_signature0)) ? ' <h6><span class="label label-danger small">without RPT Signature</span></h6>' : '' ) ;
                    },
                ...
                [ // buttons
                    ...
                    'template' => '{view}{update}{accept}{reject}{document/note-progress}',
                    'buttons' => [
                        ...
                        'accept' => function ($url, $model, $key) {
                            if ($model->status === ConstHelper::NOTE_STATUS_SUBMITTED) {
                        ...
                        'reject' => function ($url, $model, $key) {
                            if (in_array($model->status, [ConstHelper::NOTE_STATUS_SUBMITTED, ConstHelper::NOTE_STATUS_SUBMITTED_NO_RPT, ConstHelper::NOTE_STATUS_ACCEPTED], true)) {
                        ...
                        'document/note-progress' => function ($url, $model, $key) {
                            if (in_array($model->status, [ConstHelper::NOTE_STATUS_SUBMITTED, ConstHelper::NOTE_STATUS_SUBMITTED_NO_RPT, ConstHelper::NOTE_STATUS_ACCEPTED], true)) {
