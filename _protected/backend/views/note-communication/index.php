...
/* @var $searchModel common\models\searches\NoteCommunicationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->params['breadcrumbs'][] = $this->title;
?>
<div class="note-communication-index box box-primary">
    <div class="box-header with-border">
        <p class="text-right">
            <?= Html::a(Yii::t('app', 'Add Communication Note'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
        </p>
    </div>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [ // buttons
                    ...
                    'template' => '{view}{update}{accept}{reject}{document/note-communication}',
                    'buttons' => [
                        ...
                        'document/note-communication' => function ($url, $model, $key) {
                            if (!$model->isPending()) {
