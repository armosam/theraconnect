...
/* @var $searchModel common\models\searches\NoteEvalSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->params['breadcrumbs'][] = $this->title;
?>
<div class="note-eval-index box box-primary">
    <div class="box-header with-border">
        <p class="text-right">
            <?= Html::a(Yii::t('app', 'Add Eval Note'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
        </p>
    </div>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [ // buttons
                    ...
                    'template' => '{view}{update}{accept}{reject}{document/note-eval}',
                    'buttons' => [
                        ...
                        'document/note-eval' => function ($url, $model, $key) {
                            if (!$model->isPending()) {
