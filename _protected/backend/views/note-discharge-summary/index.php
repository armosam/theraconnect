...
/* @var $searchModel common\models\searches\NoteDischargeSummarySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->params['breadcrumbs'][] = $this->title;
?>
<div class="note-discharge-summary-index box box-primary">
    <div class="box-header with-border">
        <p class="text-right">
        <?= Html::a(Yii::t('app', 'Add Discharge Summary'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
        </p>
    </div>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [ // buttons
                    ...
                    'template' => '{view}{update}{accept}{reject}{document/note-discharge-summary}',
                    'buttons' => [
                        ...
                        'document/note-discharge-summary' => function ($url, $model, $key) {
                            if (!$model->isPending()) {
