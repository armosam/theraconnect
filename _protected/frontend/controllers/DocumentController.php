...
class DocumentController extends FrontendController
{
    ...
    {
        try {
            if (($model = NoteCommunication::findOne($id)) === null || !Yii::$app->user->can('manageNote', ['model' => $model])) {
    ...
    {
        try {
            if (($model = NoteDischargeOrder::findOne($id)) === null || !Yii::$app->user->can('manageNote', ['model' => $model])) {
                throw new NoteNotFoundException(Yii::t('app', 'The requested record does not exist.'));
            }
    ...
    {
        try {
            if (($model = NoteDischargeSummary::findOne($id)) === null || !Yii::$app->user->can('manageNote', ['model' => $model])) {
                throw new NoteNotFoundException(Yii::t('app', 'The requested record does not exist.'));
            }
    ...
    {
        try {
            if (($model = NoteEval::findOne($id)) === null || !Yii::$app->user->can('manageNote', ['model' => $model])) {
                throw new NoteNotFoundException(Yii::t('app', 'The requested record does not exist.'));
            }
    ...
    {
        try {
            if (($model = NoteProgress::findOne($id)) === null || !Yii::$app->user->can('manageNote', ['model' => $model])) {
                throw new NoteNotFoundException(Yii::t('app', 'The requested record does not exist.'));
            }
    ...
    {
        try {
            if (($model = NoteRouteSheet::findOne($id)) === null || !Yii::$app->user->can('manageNote', ['model' => $model])) {
                throw new NoteNotFoundException(Yii::t('app', 'The requested record does not exist.'));
            }
    ...
    {
        try {
            if (($model = NoteSupplemental::findOne($id)) === null || !Yii::$app->user->can('manageNote', ['model' => $model])) {
                throw new NoteNotFoundException(Yii::t('app', 'The requested record does not exist.'));
            }
