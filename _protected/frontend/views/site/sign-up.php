    ...
    <div class="well" style="margin: 30px auto;max-width: 368px">
        ...
        <div class="small">
            ...
            <?php if ($model->scenario === \common\models\User::SCENARIO_REGISTRATION_NEEDS_ACTIVATION): ?>
                <div class="hint-block" style="margin:1em 0">
                    <i><?= Yii::t('app', 'We are going to send you an email with an account activation link.') ?></i>
                </div>
            <?php endif ?>
        </div>
