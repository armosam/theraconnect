        ...
        <div class="box-body table-responsive">
            ...
            <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7"><?= $form->field($model, 'pain_location')->textInput(['maxlength' => true]) ?></div>
                    <div class="col-lg-3"><?= $form->field($model, 'edema')->textInput(['maxlength' => true]) ?></div>
                    <div class="col-lg-2"><?= $form->field($model, 'sensory')->radioList(['I' => 'Intact', 'N' => 'Not Intact']) ?></div>
                </div>
            <hr>
                <div class="row">
                    <div class="col-lg-6">
