...
<div class="user-notification-index">
    ...
    <p class="col-xs-12 pull-right text-right">
        <?= Html::a('<span class="glyphicon glyphicon-home"></span> '.Yii::t('app', 'Home'), ['site/index'], ['class' => 'btn btn-warning']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-edit"></span> '.Yii::t('app', 'Edit'), ['update'], ['class' => 'btn btn-primary']) ?>
    </p>
    <div class="row">
        <div class="col-md-6 col-xs-12">
            <h5><?=$model->getUserFullName()?> <?php echo (!empty($model->email) ? (' (' . $model->email . ') ') : '') ?></h5>
            <h6><?php echo !empty($model->phone1) ? (Yii::t('app', 'Phone: {phone_number}', ['phone_number' => Yii::$app->formatter->asPhone($model->phone1)])) : '' ?></h6>
            <h6><?php echo !empty($model->phone2) ? (Yii::t('app', 'Phone: {phone_number}', ['phone_number' => Yii::$app->formatter->asPhone($model->phone2)])) : '' ?></h6>
        </div>
    </div>
