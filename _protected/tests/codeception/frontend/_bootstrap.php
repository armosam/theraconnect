...
defined('YII_TEST_FRONTEND_ENTRY_SCRIPT') or define('YII_TEST_FRONTEND_ENTRY_SCRIPT',
    '/'.basename(Configuration::config()['config']['test_entry_url']));

defined('YII_TEST_FRONTEND_ENTRY_FILE') or define('YII_TEST_FRONTEND_ENTRY_FILE',
...
require_once(YII_APP_BASE_PATH . '/_protected/frontend/config/bootstrap.php');
