...
use tests\codeception\backend\AcceptanceTester as BackendAcceptanceTester;
use tests\codeception\backend\FunctionalTester as BackendFunctionalTester;
use tests\codeception\frontend\AcceptanceTester as FrontendAcceptanceTester;
use tests\codeception\frontend\FunctionalTester as FrontendFunctionalTester;
...
abstract class BasePage extends Component
{
    ...
    public $route;
    /**
     * @var Actor|BackendAcceptanceTester|BackendFunctionalTester|FrontendAcceptanceTester|FrontendFunctionalTester the testing guy object
     */
    protected $actor;
     ...
     * Constructor.
     *
     * @param Actor $I the testing guy object
     */
     ...
     * @param Actor|BackendAcceptanceTester|BackendFunctionalTester|FrontendAcceptanceTester|FrontendFunctionalTester $I the test guy instance
    ...
    public static function openBy($I, $params = [])
    {
        $page = new static($I);
        try {
            $url = $page->getUrl($params);
            $I->amOnPage($url);
        } catch (\Exception $e){
            $I->cantSeeInCurrentUrl($page->route);
        }
        return $page;
    }
}
