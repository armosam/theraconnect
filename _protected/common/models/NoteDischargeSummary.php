...
/**
 * Class NoteDischargeSummary
 * @package common\models
 */
class NoteDischargeSummary extends base\NoteDischargeSummary
{
    /**
    ...
    {
        // convert signature.png -resize 70% -transparent white -page Letter+330+35 -quality 75 signature_discharge_summary.pdf
        // $signature = Yii::getAlias('@common/pdf/signature_discharge_summary.pdf');
        ...
        try {
            ...
            $image->scaleImage(150,50, true);
            $image->setImagePage(816, 1055, 330, 35);
            ...
            Yii::error('Signature PDF for Discharge Summary failed to create. '. $e->getMessage(), 'NoteDischargeSummary::'.__FUNCTION__);
            return false;
        }
        return true;
    }
