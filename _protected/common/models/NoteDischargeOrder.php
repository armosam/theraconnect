...
/**
 * Class NoteDischargeOrder
 * @package common\models
 */
class NoteDischargeOrder extends base\NoteDischargeOrder
{
    /**
    ...
    {
        // convert signature.png -resize 70% -transparent white -page Letter+150+150 -quality 75 signature_discharge_order.pdf
        // $signature = Yii::getAlias('@common/pdf/signature_discharge_order.pdf');
        ...
        try {
            ...
            $image->setImagePage(816, 1055, 150, 150);
            ...
            Yii::error('Signature PDF for Discharge Order failed to create. '. $e->getMessage(), 'NoteDischargeOrder::'.__FUNCTION__);
            return false;
        }
        return true;
    }
