...
/**
 * This is the model class for table "{{%note_communication}}".
 *
 * @property int $id
 ...
 */
class NoteCommunication extends ActiveRecord
{
    public $save_signature;
    public $submit;
    public $name = 'Communication Note';
    public $docRoute = 'document/note-communication';
    ...
    {
        return [
            [['order_id', 'visit_id', 'provider_id', 'note_date', 'time_in', 'time_out', 'therapist_signature'], 'required'],
            ...
            [['dob', 'mrn', 'patient_phone_number', 'physician_phone_number', 'note_date', 'therapist_title', 'physician_date', 'time_in', 'time_out'], 'string', 'max' => 100],
            [['health_agency', 'patient_name', 'patient_address', 'physician_name', 'physician_address', 'patient_status_findings', 'therapist_name', 'physician_signature'], 'string', 'max' => 255],
        ...
        return [
            ...
            /*'status' => [
                ...
                'value' => function ($event) {
                    return ConstHelper::NOTE_STATUS_PENDING;
                },
            ],*/
        ];
    }
    ...
    {
        return $this->hasOne(Order::class, ['id' => 'order_id'])->inverseOf('communicationNotes');
    }
    ...
    {
        return $this->hasOne(Visit::class, ['id' => 'visit_id', 'order_id' => 'order_id'])->inverseOf('communicationNote');
    }
    ...
    /**
     * {@inheritdoc}
     * @return NoteCommunicationQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new NoteCommunicationQuery(get_called_class());
    }
}
