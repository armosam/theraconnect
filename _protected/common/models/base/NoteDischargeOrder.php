...
/**
 * This is the model class for table "{{%note_discharge_order}}".
 *
 * @property int $id
 ...
 */
class NoteDischargeOrder extends ActiveRecord
{
    public $save_signature;
    public $submit;
    public $name = 'Discharge Order';
    public $docRoute = 'document/note-discharge-order';
    ...
    public function rules()
    {
        return [
            ...
            [['health_agency', 'patient_name', 'patient_address', 'physician_name', 'physician_address', 'patient_status_findings', 'physician_orders', 'therapist_name', 'physician_signature'], 'string', 'max' => 255],
    ...
    {
        return $this->hasOne(Order::class, ['id' => 'order_id'])->inverseOf('dischargeOrderNotes');
    }
    ...
    {
        return $this->hasOne(Visit::class, ['id' => 'visit_id', 'order_id' => 'order_id'])->inverseOf('dischargeOrderNote');
    }
    ...
    /**
     * {@inheritdoc}
     * @return NoteDischargeOrderQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new NoteDischargeOrderQuery(get_called_class());
    }
}
