 ...
 */
class NoteEval extends base\NoteEval
{
    /**
    ...
    public function setExistingAttributes()
    {
        ...
        $this->setAttributes([
            ...
            'soc' => $this->order->patient->start_of_care,
    ...
    {
        // convert signature.png -resize 70% -transparent white -page Letter+100-5 -quality 75 signature_eval.pdf
        // $signature = Yii::getAlias('@common/pdf/signature_eval.pdf');
        ...
        try {
            ...
            $image->setImagePage(816, 1055, 100, 25);
            ...
            Yii::error('Signature PDF for Eval Note failed to create. '. $e->getMessage(), 'NoteEval::'.__FUNCTION__);
            return false;
        }
        return true;
    }
