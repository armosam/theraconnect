	...
	;(function(drawEndHandler, drawStartHandler, drawMoveHandler) {
		...
		if (this.isCanvasEmulator){
			...
			this.ontouchstart = function(e) {
				...
				if (hasEventListener) {
					canvas.addEventListener('touchend', drawEndHandler, {passive: false, capture: false});
					canvas.addEventListener('touchstart', drawStartHandler, {passive: false, capture: false});
					canvas.addEventListener('touchmove', drawMoveHandler, {passive: false, capture: false});
				} else {
			...
			if (hasEventListener) {
				canvas.addEventListener('touchstart', this.ontouchstart, {passive: false, capture: false});
			} else {
