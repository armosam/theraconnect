...
/**
 * Class ArticleSmsSenderJob.
 *
 * @property int $ttr
 */
class ArticleSmsSenderJob extends BaseObject implements RetryableJobInterface
{
    /**
     * @var integer $user_id
     */
    ...
    public function execute($queue)
    {
        ...
        $article->on(Article::EVENT_NEWS_CREATED, [$user, 'newsCreatedEventHandler'], 'sms');
